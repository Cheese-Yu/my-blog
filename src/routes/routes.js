...
const Home = resolve => require(['../components/fronted/Home'], resolve);
export default [

  {
    ...
    hidden:true,
    children:[
      {path:'',redirect:'blog',  meta:{auth:false}},
      {path:'blog',component:Home,  meta:{auth:false}},
      {path:'tags',component:Tags,  meta:{auth:false}},
      {path:'blog/article/:id',component:Article, meta:{auth:false,scrollToTop: true}},
      {path:'tags/article/:id',component:Article, meta:{auth:false,scrollToTop: true}},
    ]
  },
  {
    path:'/login',
